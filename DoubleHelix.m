...
%
% Mostly works. Concerns I have:
%   * Power in lobes goes down with each iteration rather than up
%   * z=0 lobes look slightly wonky
...
xticks('');
yticks('');
saveas(gcf, 'Results/Double Helix Hologram.png')
save("Results/Double Helix Hologram.m", 'Holo');
